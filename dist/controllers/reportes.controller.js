...
function getFacturas(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            sql += " (select numerodocumento from t_registros where relacionado = a.numerodocumento and idtipodocumento = 2 ) as notadebito, ";
            sql += " (select numerodocumento from t_registros where relacionado = a.numerodocumento and idtipodocumento = 3 ) as notacredito ";
